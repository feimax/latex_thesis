%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [编译方式]
% mac/linux: 在terminal执行 ./make_mac_linux.sh
% windows: 双击 make_windows.bat
% 在sublime 直接 ctrl+b 或 command+b (mac) 可能造成命名表有问题
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [页面选项]
%
% 字号选项:    12pt是字号，比较适合电子印刷品和纸质印刷品
% 字体选项:    不填写 - 默认为 Modern (别忘了连逗号一起删了)
%			  times - Times New Roman
%			  sans - Sans Serif 字体（黑体）
% twoside:    oneside 代表单面，一般单侧用于电子印刷品
% 		      twoside，一般用于双面纸质印刷
% openright:  双面打印的情况下，纸质印刷品要求新的一章从奇数页开始
% hardcopy:   打印机打印选项，带有此选项将去除logo颜色以及代码颜色，更适合黑白印刷
%			  使用彩色或者电子版请去除此选项
%			  也可以改为 editing ，颜色个和 sublime3 的 Mariana 
%             颜色主题一致，减小写作时的文本对比度
%		      让你以最舒适的方式书写
% heading:    页面带有页眉
\documentclass[12pt,times,twoside,openright,hardcopy]{thesis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% candidate: 自己的名字
% submitdate: 提交日期
\title{\LaTeX{} Teamplate for PhD Thesis}
\candidate{Your NAME}
\submitdate{1st, June, 2018}
...
\chapter*{Appendix A}\label{cpt:pbl}
\section*{A list of Publications}
